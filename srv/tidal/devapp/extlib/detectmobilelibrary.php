...
//OUTSIDE LIBRARY TO DETECT MOBILE DEVICES
/**
...
class Mobile_Detect
{
    ...
    protected static $phoneDevices = array(
        ...
        'INQ'           => 'INQ',
        // is a mobile app; http://support.tapatalk.com/threads/smf-2-0-2-os-and-browser-detection-plugin-and-tapatalk.15565/#post-79039
    ...
    protected static $tabletDevices = array(
        ...
        //  Rewrite the regex format after we add more UAs.
    ...
    public function setUserAgent($userAgent = null)
    {
        ...
        if (false === empty($userAgent)) {
            ...
            foreach ($this->getUaHttpHeaders() as $altHeader) {
                if (false === empty($this->httpHeaders[$altHeader])) { // should use getHttpHeader(), but it would be slow. (Serban)
